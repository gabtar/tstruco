...
- [ ] FIX: Chanting a Flor should add 3 points to the player directly. But if any player from the opponent team has a flor, he should be able to chant contra flor or contra flor al resto, so i should not add directly the 3 points. Need to check rules on flor...
